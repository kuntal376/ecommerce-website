        ...
        <>
            <div className="category-card">
                <div className="category-electronics">
                    ...
                    <img src={Electronics} alt="Electronics" className="w-22 h-22 object-cover rounded-full" />
                    <h3 className="font-[500]">Electronics ▾</h3>
                    </div>
                    <div className="Electronics-Menu text-sm flex flex-col gap-1 mt-2 font-[400]">
                ...
                <div className="category-fashion">
                    <div className="flex flex-col items-center">
                    <img src={Fashion} alt="Fashion" className="w-22 h-22 object-cover rounded-full" />
                    <h3 className="font-[500]">Fashion ▾</h3>
                    </div>
                    <div className="Fashion-Menu text-sm flex flex-col gap-1 mt-2 font-[400]">
                        ...
                        <Link to="/Watches-Accessories">Watches & Accessories</Link>
                ...
                <div className="category-home-appliances">
                    <div className="flex flex-col items-center">
                    <img src={Appliances} alt="Home Appliances" className="w-22 h-22 object-cover rounded-full" />
                    <h3 className="font-[500]">Home Appliances ▾</h3>
                    </div>
                    <div className="Appliances-Menu text-sm flex flex-col gap-1 mt-2 font-[400]">
                        ...
                        <Link to="/Vacuum-Cleaners">Vacuum Cleaners</Link>
                    </div>
                </div>
                <div className="category-furniture">
                    <div className="flex flex-col items-center">
                    <img src={Furniture} alt="Furniture" className="w-22 h-22 object-cover rounded-full" />
                    <h3 className="font-[500]">Furniture ▾</h3>
                    </div>
                    <div className="Furniture-Menu text-sm flex flex-col gap-1 mt-2 font-[400]">
                        ...
                        <Link to="/Outdoor-Furniture">Outdoor Furniture</Link>
                    </div>
                </div>
                <div className="category-groceries">
                    <div className="flex flex-col items-center">
                    <img src={Groceries} alt="Groceries" className="w-22 h-22 object-cover rounded-full" />
                    <h3 className="font-[500]">Groceries ▾</h3>
                    </div>
                    <div className="Groceries-Menu text-sm flex flex-col gap-1 mt-2 font-[400]">
                ...
                <div className="category-sports">
                    <div className="flex flex-col items-center">
                    <img src={Sports} alt="Sports" className="w-22 h-22 object-cover rounded-full" />
                    <h3 className="font-[500]">Sports ▾</h3>
                    </div>
                    <div className="Sports-Menu text-sm flex flex-col gap-1 mt-2 font-[400]">
                ...
                <div className="category-beauty-health">
                    <div className="flex flex-col items-center">
                    <img src={BeautyHealth} alt="Beauty & Health" className="w-22 h-22 object-cover rounded-full" />
                    <h3 className="font-[500]">Beauty & Health ▾</h3>
                    </div>
                    <div className="Beauty-Health-Menu text-sm flex flex-col gap-1 mt-2 font-[400]">
                ...
                <div className="category-book-toys">
                    <div className="flex flex-col items-center">
                    <img src={BooksToys} alt="Books & Toys" className="w-22 h-22 object-cover rounded-full" />
                    <h3 className="font-[500]">Books & Toys ▾</h3>
                    </div>
                    <div className="Books-Toys-Menu text-sm flex flex-col gap-1 mt-2 font-[400]">
                        <Link to="/Books">Books</Link>
                        <Link to="/Toys-Games">Toys & Games</Link>
                        <Link to="/Musical-Instruments">Musical Instruments</Link>
