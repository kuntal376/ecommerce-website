...
const MenFootwearFilter = ({ filters, setFilters }) => {
    ...
    <>
      <aside className="w-64 bg-white border rounded-md p-4 h-min">
        ...
        <div className="mb-4">
          ...
          {open.type && (
            <div className="mt-2 space-y-1 text-sm">
              {["Boots", "Sneakers", "Oxford", "Sandal", "Running Shoes"].map((v) => (
        ...
        <div className="mb-4">
          ...
          {open.brand && (
            <div className="mt-2 space-y-1 text-sm">
              {["Afrojack", "BTOM", "Glitchz", "CAMPUS", "Shimer"].map((v) => (
                <label key={v} className="flex gap-2">
                  <input
                    type="checkbox"
...
export default MenFootwearFilter;
