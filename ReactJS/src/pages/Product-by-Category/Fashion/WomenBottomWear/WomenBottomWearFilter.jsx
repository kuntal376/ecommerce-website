    ...
    <>
      <aside className="w-64 bg-white border rounded-md p-4 h-min">
        ...
        <div className="mb-4">
          ...
          {open.dressType && (
            <div className="mt-2 space-y-1 text-sm">
              {["Jeans", "Leggings", "Salwar", "Skirt", "Trousers"].map((v) => (
        ...
        <div className="mb-4">
          ...
          {open.fabric && (
            <div className="mt-2 space-y-1 text-sm">
              {["Cotton", "Polyester","Denim", "Lycra", "Rayon"].map((v) => (
                <label key={v} className="flex gap-2">
                  <input
                    type="checkbox"
        ...
        <div className="mb-4">
          ...
          {open.brand && (
            <div className="mt-2 space-y-1 text-sm">
              {["Beauty Garments", "Deklook", "Guti", "House of Common", "Mannat", "NUCOUTHS", "PINOVO", "Smart Vision", "Stywa"].map((v) => (
                <label key={v} className="flex gap-2">
                  <input
                    type="checkbox"
        ...
        <button
          onClick={() =>
            setFilters({dressType: [], fabric: [], brand: [], occasion:[], fit: [], price: "", sort: "none"})
