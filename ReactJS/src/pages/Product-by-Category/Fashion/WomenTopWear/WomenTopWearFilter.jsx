...
const WomenTopWearFilter = ({ filters, setFilters }) => {
    ...
    <>
      <aside className="w-64 bg-white border rounded-md p-4 h-min">
        ...
        <div className="mb-4">
          ...
          {open.dressType && (
            <div className="mt-2 space-y-1 text-sm">
              {["Top", "Kurta", "Lehenga","Gown", "Dress"].map((v) => (
        ...
        <div className="mb-4">
          ...
          {open.fabric && (
            <div className="mt-2 space-y-1 text-sm">
              {["Cotton", "Polyester","Silk", "Rayon"].map((v) => (
                <label key={v} className="flex gap-2">
                  <input
                    type="checkbox"
        ...
        <div className="mb-4">
          ...
          {open.brand && (
            <div className="mt-2 space-y-1 text-sm">
              {["Angarkha", "Juniper", "Kedar Fab", "Nayo", "House of Common", "Look Link", "Rare Thread", "Udbhav", "Siya"].map((v) => (
                <label key={v} className="flex gap-2">
                  <input
                    type="checkbox"
        ...
        <div className="mb-4">
          ...
          {open.sleeve && (
            <div className="mt-2 space-y-1 text-sm">
              {["Full Sleeve","Mid Sleeve","Half Sleeve", "Sleeveless"].map((v) => (
                <label key={v} className="flex gap-2">
                  <input
                    type="checkbox"
        ...
        <button
          onClick={() =>
            setFilters({dressType: [], fabric: [], brand: [], sleeve: [], occasion:[], price: "", sort: "none"})
...
export default WomenTopWearFilter;