      ...
      <div className='w-[60%] bg-[#f1f1f1] px-4 rounded-md py-3'>
        ...
        <div className='mt-5 flex items-center gap-5'>
            <div className='w-[50%]'>
                ...
                <input type="text" name="displaySize" onChange={handleChange} id="displaySize" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. 6.7 inches"/>
            </div>
            <div className='w-[50%]'>
                <label htmlFor="displayType" className="block mb-2.5 text-sm font-medium text-heading">Display Type:</label>
                <input type="text" name="displayType" onChange={handleChange} id="displayType" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. PLS LCD"/>
            </div>
        </div>
        <div className='mt-5'>
            <label htmlFor="processor" className="block mb-2.5 text-sm font-medium text-heading">Processor:</label>
            <input type="text" name="processor" onChange={handleChange} id="processor" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. MediaTek Dimensity 6100+"/>
        </div>
        <div className='mt-5 flex items-center gap-5'>
            <div className='w-[50%]'>
                <label htmlFor="frontCamera" className="block mb-2.5 text-sm font-medium text-heading">Front Camera:</label>
                <input type="text" name="frontCamera" onChange={handleChange} id="frontCamera" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. 8 MP"/>
            </div>
            <div className='w-[50%]'>
                <label htmlFor="backCamera" className="block mb-2.5 text-sm font-medium text-heading">Back Camera:</label>
                <input type="text" name="backCamera" onChange={handleChange} id="backCamera" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. 50 MP"/>
            </div>
        </div>
      </div>
