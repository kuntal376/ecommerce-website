...
const Kids = ({ onDataChange }) => {

    const [details, setDetails] = useState({
        dressType: '', // e.g. Frock, T-Shirt, Shorts, Romper
        fabric: '',    // e.g. Cotton, Fleece, Denim
        ageGroup: '',  // e.g. 0-2 Years, 3-5 Years (Added for 4th line)
        occasion: '',  // e.g. Casual, Party, School, Playtime
        //market info
        sku:'',
        stockLevel:'',
        taxClass:'',
    ...
    <div className='flex items-center gap-3'>
      ...
      <div className='w-[60%] bg-[#f1f1f1] px-4 rounded-md py-3'>
        ...
        <div className='mt-5'>
            ...
            <input type="text" name="dressType" onChange={handleChange} id="dressType" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Frock, T-Shirt, Romper"/>
        </div>

        {/* Line 2: Fabric */}
        <div className='mt-5'>
            <label htmlFor="fabric" className="block mb-2.5 text-sm font-medium text-heading">Fabric:</label>
            <input type="text" name="fabric" onChange={handleChange} id="fabric" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Cotton, Fleece, Denim"/>
        </div>

        {/* Line 3: Age Group (Added for layout balance) */}
        <div className='mt-5'>
            <label htmlFor="ageGroup" className="block mb-2.5 text-sm font-medium text-heading">Age Group:</label>
            <input type="text" name="ageGroup" onChange={handleChange} id="ageGroup" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. 2-3 Years, 5-6 Years, Infant"/>
        </div>

        {/* Line 4: Occasion */}
        <div className='mt-5'>
            <label htmlFor="occasion" className="block mb-2.5 text-sm font-medium text-heading">Occasion:</label>
            <input type="text" name="occasion" onChange={handleChange} id="occasion" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Playtime, Party, School"/>
        </div>
      </div>
