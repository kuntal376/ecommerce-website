...
const WomenFootwear = ({ onDataChange }) => {

    const [details, setDetails] = useState({
        type: '',        // e.g. Heels, Sandals, Sneakers, Boots
        material: '',    // e.g. Leather, Suede, Synthetic
        heelType: '',    // e.g. Stiletto, Wedge, Block, Flat (Added for 4th line)
        occasion: '',    // e.g. Party, Casual, Office
        //market info
        sku:'',
        stockLevel:'',
        taxClass:'',
    ...
    <div className='flex items-center gap-3'>
      ...
      <div className='w-[60%] bg-[#f1f1f1] px-4 rounded-md py-3'>
        ...
        <div className='mt-5'>
            ...
            <input type="text" name="type" onChange={handleChange} id="type" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Heels, Sandals, Sneakers"/>
        </div>

        {/* Line 2: Material */}
        <div className='mt-5'>
            <label htmlFor="material" className="block mb-2.5 text-sm font-medium text-heading">Material:</label>
            <input type="text" name="material" onChange={handleChange} id="material" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Leather, Velvet, Suede"/>
        </div>

        {/* Line 3: Heel Type (Added for layout balance) */}
        <div className='mt-5'>
            <label htmlFor="heelType" className="block mb-2.5 text-sm font-medium text-heading">Heel Type:</label>
            <input type="text" name="heelType" onChange={handleChange} id="heelType" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Stiletto, Block, Wedge, Flat"/>
        </div>

        {/* Line 4: Occasion */}
        <div className='mt-5'>
            <label htmlFor="occasion" className="block mb-2.5 text-sm font-medium text-heading">Occasion:</label>
            <input type="text" name="occasion" onChange={handleChange} id="occasion" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Party, Office, Casual"/>
        </div>
      </div>
