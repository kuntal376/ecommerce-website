...
const DiningRoom = ({ onDataChange }) => {

    const [details, setDetails] = useState({
        furnitureType: '',      // e.g. Dining Table, Dining Chair, Buffet, Bar Stool
        structureMaterial: '',  // e.g. Solid Wood, Glass, Metal, Marble
        style: '',              // e.g. Modern, Farmhouse, Contemporary, Traditional (Added for 3rd line)
        features: '',           // e.g. Extendable, Stackable, Upholstered Seat, Scratch Resistant
        ...
        <div className='flex items-center gap-3'>
            ...
            <div className='w-[60%] bg-[#f1f1f1] px-4 rounded-md py-3'>
                ...
                <div className='mt-5'>
                    ...
                    <input type="text" name="furnitureType" onChange={handleChange} id="furnitureType" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Dining Table, Chair, Buffet, Bar Stool"/>
                </div>
                ...
                <div className='mt-5'>
                    ...
                    <input type="text" name="structureMaterial" onChange={handleChange} id="structureMaterial" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Solid Wood, Glass, Metal, Marble"/>
                </div>

                {/* Line 3: Style / Design */}
                <div className='mt-5'>
                    <label htmlFor="style" className="block mb-2.5 text-sm font-medium text-heading">Style / Design:</label>
                    <input type="text" name="style" onChange={handleChange} id="style" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Modern, Farmhouse, Contemporary, Traditional"/>
                </div>

                {/* Line 4: Special Features */}
                <div className='mt-5'>
                    <label htmlFor="features" className="block mb-2.5 text-sm font-medium text-heading">Key Features:</label>
                    <input type="text" name="features" onChange={handleChange} id="features" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Extendable, Stackable, Upholstered Seat"/>
                </div>
            </div>
