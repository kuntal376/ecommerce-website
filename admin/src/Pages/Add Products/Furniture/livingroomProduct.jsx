...
const LivingRoom = ({ onDataChange }) => {

    const [details, setDetails] = useState({
        furnitureType: '',      // e.g. Sofa, Coffee Table, Recliner, TV Stand
        fillingMaterial: '',    // e.g. High Density Foam, Down Feather, Cotton, Synthetic Fiber
        style: '',              // e.g. Modern, Mid-Century, Scandinavian, Traditional (Added for 3rd line)
        features: '',           // e.g. Reclining, Stain Resistant, Modular, Convertible
        ...
        <div className='flex items-center gap-3'>
            ...
            <div className='w-[60%] bg-[#f1f1f1] px-4 rounded-md py-3'>
                ...
                <div className='mt-5'>
                    ...
                    <input type="text" name="furnitureType" onChange={handleChange} id="furnitureType" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Sofa, Sectional, Coffee Table, Recliner"/>
                </div>

                {/* Line 2: Filling Material */}
                <div className='mt-5'>
                    <label htmlFor="fillingMaterial" className="block mb-2.5 text-sm font-medium text-heading">Filling / Core Material:</label>
                    <input type="text" name="fillingMaterial" onChange={handleChange} id="fillingMaterial" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. High Density Foam, Down Feather, Pocket Spring"/>
                </div>

                {/* Line 3: Style / Design */}
                <div className='mt-5'>
                    <label htmlFor="style" className="block mb-2.5 text-sm font-medium text-heading">Style / Design:</label>
                    <input type="text" name="style" onChange={handleChange} id="style" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Modern, Mid-Century, Scandinavian, Traditional"/>
                </div>

                {/* Line 4: Special Features */}
                <div className='mt-5'>
                    <label htmlFor="features" className="block mb-2.5 text-sm font-medium text-heading">Key Features:</label>
                    <input type="text" name="features" onChange={handleChange} id="features" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Reclining Mechanism, Stain Resistant Fabric, Modular"/>
                </div>
            </div>
