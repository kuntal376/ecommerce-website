...
const OfficeFurniture = ({ onDataChange }) => {

    const [details, setDetails] = useState({
        furnitureType: '',      // e.g. Office Chair, Desk, Filing Cabinet, Bookshelf
        structureMaterial: '',  // e.g. Metal, Mesh, Engineered Wood, Plastic
        style: '',              // e.g. Ergonomic, Modern, Executive, Industrial (Added for 3rd line)
        features: '',           // e.g. Adjustable Height, Lumbar Support, Lockable
        ...
        <div className='flex items-center gap-3'>
            ...
            <div className='w-[60%] bg-[#f1f1f1] px-4 rounded-md py-3'>
                ...
                <div className='mt-5'>
                    ...
                    <input type="text" name="furnitureType" onChange={handleChange} id="furnitureType" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Office Chair, Standing Desk, Filing Cabinet"/>
                </div>
                ...
                <div className='mt-5'>
                    ...
                    <input type="text" name="structureMaterial" onChange={handleChange} id="structureMaterial" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Mesh, Metal, Engineered Wood, Leather"/>
                </div>

                {/* Line 3: Style / Design */}
                <div className='mt-5'>
                    <label htmlFor="style" className="block mb-2.5 text-sm font-medium text-heading">Style / Design:</label>
                    <input type="text" name="style" onChange={handleChange} id="style" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Ergonomic, Modern, Executive, Industrial"/>
                </div>

                {/* Line 4: Special Features */}
                <div className='mt-5'>
                    <label htmlFor="features" className="block mb-2.5 text-sm font-medium text-heading">Key Features:</label>
                    <input type="text" name="features" onChange={handleChange} id="features" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Adjustable Height, Lumbar Support, Lockable, Wheels"/>
                </div>
            </div>
