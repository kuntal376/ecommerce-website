...
const LargeAppliances = ({ onDataChange }) => {

    const [details, setDetails] = useState({
        applianceType: '', // e.g. Refrigerator, Washing Machine, Air Conditioner
        capacityValue: '', // e.g. 260, 7.5, 1.5
        capacityUnit: '',  // e.g. Liters, Kg, Ton
        features: '',      // e.g. Inverter, 5 Star Rating, Front Load
        //market info
        sku:'',
        stockLevel:'',
        taxClass:'',
    ...
    <div className='flex items-center gap-3'>
      ...
      <div className='w-[60%] bg-[#f1f1f1] px-4 rounded-md py-3'>
        ...
        <div className='mt-5'>
            ...
            <input type="text" name="applianceType" onChange={handleChange} id="applianceType" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Refrigerator, Washing Machine, AC"/>
        </div>

        {/* Line 2: Capacity Value */}
        <div className='mt-5'>
            <label htmlFor="capacityValue" className="block mb-2.5 text-sm font-medium text-heading">Capacity Value:</label>
            <input type="text" name="capacityValue" onChange={handleChange} id="capacityValue" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. 260, 7.5, 1.5"/>
        </div>

        {/* Line 3: Capacity Unit */}
        <div className='mt-5'>
            <label htmlFor="capacityUnit" className="block mb-2.5 text-sm font-medium text-heading">Capacity Unit:</label>
            <input type="text" name="capacityUnit" onChange={handleChange} id="capacityUnit" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Liters, Kg, Ton"/>
        </div>

        {/* Line 4: Features */}
        <div className='mt-5'>
            <label htmlFor="features" className="block mb-2.5 text-sm font-medium text-heading">Key Features:</label>
            <input type="text" name="features" onChange={handleChange} id="features" className="bg-[#e3e3e3] text-heading text-sm rounded-md focus:ring-[#e3e3e3] focus:border-[#e3e3e3] w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="e.g. Inverter Tech, 5 Star Rating, Frost Free"/>
        </div>
      </div>
