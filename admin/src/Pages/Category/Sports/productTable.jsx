...
const ProductTable = () => {
    const [products] = useState([
        { 
            ...
            status: 'Low Stock',
            variants: [
                { spec: 'Standard Model', stock: 8, sold: 50 },
                { spec: 'Auto-Incline Model', stock: 2, sold: 30 }
            ]
        },
        { 
            id: 'SPT-002', 
            ...
            status: 'In Stock',
            variants: [
                { spec: 'Size 6', stock: 20, sold: 120 },
                { spec: 'Full Size (SH)', stock: 25, sold: 200 }
            ]
        },
        { 
            id: 'SPT-003', 
            ...
            status: 'In Stock',
            variants: [
                { spec: '6mm - Blue', stock: 60, sold: 400 },
                { spec: '8mm - Purple', stock: 60, sold: 350 }
            ]
        },
        { 
            id: 'SPT-004', 
                                ...
                                {expandedRow === item.id && (
                                    <tr className="bg-gray-50">
                                        <td colSpan="7" className="p-0 border-b border-gray-200">
                                            <div className="p-6">
                                                <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-3">Equipment Specs & Sales</h4>
                                                <table className="w-full text-sm text-left bg-white rounded border border-gray-200">
                                                    <thead className="bg-gray-100 text-gray-600">
                                                        <tr>
                                                            <th className="p-3 font-semibold">Specification / Size</th>
                                                        ...
                                                        {item.variants.map((variant, idx) => (
                                                            <tr key={idx} className="hover:bg-gray-50">
                                                                ...
                                                                <td className="p-3 flex items-center gap-2">
                                                                    ...
                                                                    {variant.stock > 0 ? 'In Warehouse' : 'Out of Stock'}
                                                                </td>
                                                            </tr>
                                                        ))}
                                                    </tbody>
