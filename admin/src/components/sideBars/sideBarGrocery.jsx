      ...
      <div className="logo ">
        ...
        <ul className='my-10'>
            ...
            <li className='bg-[#afcbff]'>
                ...
                <Collapse isOpened={menuIndex===1 ? false : true}>
                    <ul>
                        ...
                        <li className='bg-[#fff] pl-5'>
                            <Link to={'/grocery-product'}>
                            <Button className='w-full h-12 !justify-start !capitalize flex items-center gap-3 text-[16px] !font-[700] items-center'>
                                <span className='w-1 h-1 rounded-full bg-[#007bff]'/>Grocery
                            </Button>
                            </Link>
                        </li>
                        <li className='hover:bg-[#fff] pl-5'>
