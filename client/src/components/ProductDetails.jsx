      ...
      <div>
        ...
        <div className="mt-6">
          ...
          <ul className="text-sm text-gray-600 space-y-1">
            <li><b>RAM:</b> {product.specs?.ram}</li>
            <li><b>ROM:</b> {product.specs?.rom}</li>
            <li><b>Processor:</b> {product.specs?.processor}</li>
            <li><b>Display:</b> {product.specs?.displaySize}</li>
            <li><b>Front Camera:</b> {product.specs?.frontCamera}</li>
            <li><b>Back Camera:</b> {product.specs?.backCamera}</li>
          </ul>
        </div>
      </div>
    </div>
