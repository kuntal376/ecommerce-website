...
import SkinCareProductsData from "./SkinCareProductsData";
...
// MOCK DATA
const mockProducts = SkinCareProductsData;
...
const SkinCareProducts = ({ filters, apiData }) => {
  ...
  if (filteredProducts.length === 0) {
      return <div className="text-center p-10 text-gray-500">No Skin Care products found matching your filters.</div>
  }
