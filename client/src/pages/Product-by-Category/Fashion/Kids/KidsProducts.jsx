...
import KidsProductsData from "./KidsProductsData";


// MOCK DATA
const mockProducts = KidsProductsData;
...
const KidsProducts = ({ filters, apiData }) => {
      ...
      {filteredProducts.map((product) => {
        ...
        <div key={product.id || product._id} className="border rounded-md p-4 bg-white hover:shadow-lg transition">
          ...
          <div className="text-sm mt-3 grid grid-cols-[90px_1fr] gap-y-1">
            ...
            <span className="font-medium text-gray-500">Fabric:</span><span>{product.specs?.fabric}</span>
