...
import WomenBottomWearProductsData from "./WomenBottomWearProductsData";

// MOCK DATA
const mockProducts = WomenBottomWearProductsData;
...
const WomenBottomWearProducts = ({ filters, apiData }) => {
...
export default WomenBottomWearProducts;