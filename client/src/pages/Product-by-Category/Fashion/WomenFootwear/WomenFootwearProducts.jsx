...
import WomenFootwearProductsData from "./WomenFootwearProductsData";

// MOCK DATA
const mockProducts = WomenFootwearProductsData;
...
const WomenFootwearProducts = ({ filters, apiData }) => {
  ...
  let filteredProducts = productsToDisplay.filter((product) => {
    ...
    const occasionMatch = filters.occasion.length === 0 || filters.occasion.includes(product.specs?.occasion);
