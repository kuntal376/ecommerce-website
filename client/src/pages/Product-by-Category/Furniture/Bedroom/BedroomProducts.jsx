...
import BedroomProductsData from "./BedroomProductsData";
...
// MOCK DATA
const mockProducts = BedroomProductsData;
...
const BedroomProducts = ({ filters, apiData }) => {
  ...
  if (filteredProducts.length === 0) {
      return <div className="text-center p-10 text-gray-500">No Bedroom products found matching your filters.</div>
  }
