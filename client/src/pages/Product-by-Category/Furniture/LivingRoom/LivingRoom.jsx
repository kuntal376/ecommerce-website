...
import LivingRoomProducts from "./LivingRoomProducts";
...
const LivingRoom = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setIsLoading(true);
            try {
                const data = await getProductsByCategory("Living Room");
    ...
    return (
        <>
            <section className="p-4 font-bold text-2xl border-b border-gray-200">Living Room</section>
            ...
            <section className="Furniture-section">
                <div className="Furniture-bars flex flex-col md:flex-row gap-4 p-4 h-full">
                    ...
                    <div className="w-full md:w-1/4 lg:w-64 flex-shrink-0">
                        <LivingRoomFilter filters={filters} setFilters={setFilters} subCategory="Living Room"/>
                    </div>
                    ...
                    <div className="flex-1 w-full">
                        {isLoading ? (
                            ...
                            <LivingRoomProducts apiData={apiProducts} filters={filters} />
                        )}
                    </div>
