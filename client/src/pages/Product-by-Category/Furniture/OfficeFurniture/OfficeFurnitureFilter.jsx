...
const OfficeFurnitureFilter = ({ filters, setFilters, subCategory }) => {
  ...
  return (
    <aside className="w-full bg-white border rounded-md p-4 shadow-sm h-min">
      ...
      <div className="mb-4 border-b pb-4">
        ...
        {open.price && (
          <div className="mt-3 space-y-2 text-sm text-gray-600">
            {[1000, 5000, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000].map((p) => (
...
export default OfficeFurnitureFilter;