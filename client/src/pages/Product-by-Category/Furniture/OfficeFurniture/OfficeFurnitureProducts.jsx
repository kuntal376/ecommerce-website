...
import OfficeFurnitureProductsData from "./OfficeFurnitureProductsData";
...
// MOCK DATA
const mockProducts = OfficeFurnitureProductsData;
...
const OfficeFurnitureProducts = ({ filters, apiData }) => {
  ...
  if (filteredProducts.length === 0) {
      return <div className="text-center p-10 text-gray-500">No OfficeFurniture products found matching your filters.</div>
  }
...
export default OfficeFurnitureProducts;