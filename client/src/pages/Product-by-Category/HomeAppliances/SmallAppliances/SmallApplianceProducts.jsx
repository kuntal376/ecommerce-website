...
// MOCK DATA
const mockProducts = SmallApplianceProductsData;
...
const SmallApplianceProducts = ({ filters, apiData }) => {
  ...
  if (filteredProducts.length === 0) {
      return <div className="text-center p-10 text-gray-500">No small appliances found matching your filters.</div>
  }
